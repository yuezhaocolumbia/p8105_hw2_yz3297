...
Answers to the questions (used inline code)

There are `r count(distinct(brfssnew_data, locationdesc))` unique locations in the dataset.  There are `r count(distinct(brfssnew_data, locationabbr))` states represented, so 
