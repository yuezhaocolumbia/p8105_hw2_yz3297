...
There are 400 unique locations in the dataset. There are 51 location abbreviations for states (or district), so we know all 50 states and Washington DC were represented.
